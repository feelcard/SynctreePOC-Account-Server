...
public class DatabaseConfig {
  ...
  public DataSource dataSource() {
    ...
    try {
      ...
      dataSource.setUrl("jdbc:mysql://localhost:3306/carddb?characterEncoding=UTF-8&serverTimezone=Asia/Seoul"); //env.getProperty("spring.datasource.url")
      dataSource.setUsername("card");//env.getProperty("spring.datasource.username")
      dataSource.setPassword("card");//env.getProperty("spring.datasource.password")
    } catch (Exception e) {
